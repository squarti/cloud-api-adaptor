...
func (_ *Manager) ParseCmd(flags *flag.FlagSet) {
	...
	flags.StringVar(&ibmcloudPowerVSConfig.ApiKey, "powervs-api-key", "", "IBM Cloud API key, defaults to `IBMCLOUD_API_KEY`")
	...
	flags.StringVar(&ibmcloudPowerVSConfig.ImageID, "powervs-image-id", "", "ID of the boot image")
